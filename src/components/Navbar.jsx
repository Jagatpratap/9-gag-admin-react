        ...
        <nav className='w-full bg-white h-[70px] flex flex-row items-center'>
            <div className="flex flex-row w-full px-[50px] mx-auto">
                ...
                <div className="flex-row hidden w-3/5 md:flex">
                    <img src={"/instagram.svg"} width={27} height={27} />
                ...
                <div className='flex flex-row justify-end w-full m-auto divide-x md:w-1/5'>
                    <span className='px-3 cursor-pointer'>
                        <img className='hover:fill-secondary3' src={"/notification.svg"} width={25} height={25} />
                    </span>
                    <span className='px-3 cursor-pointer'>
                        <img className='hover:fill-secondary3' src={"/profile.svg"} width={25} height={25} />
                    </span>
                    <span className='px-3 cursor-pointer'>
                        <img className='hover:fill-secondary3' src={"/setting.svg"} width={25} height={25} />
                    </span>
                </div>
            </div>
        </nav>
